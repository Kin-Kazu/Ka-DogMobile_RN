...
const KaDogDashboard2 = () => {
  ...
  return (
    <View style={styles.kaDogDashboard2}>
      <Image
      ...
      />
      <View style={styles.kaDogDashboard2Child} />
      <View style={[styles.kaDogDashboard2Item, styles.dogPosition]} />
      <View style={[styles.kaDogDashboard2Inner, styles.dogPosition]} />
      <View style={styles.rectangleView} />
      <View style={[styles.kaDogDashboard2Child1, styles.dogChildLayout]} />
      <Text style={[styles.text, styles.textTypo1]}>113</Text>
      <View style={[styles.kaDogDashboard2Child2, styles.dogChildLayout]} />
      <Text style={[styles.text1, styles.textTypo1]}>300</Text>
      <View style={styles.kaDogDashboard2Child3} />
